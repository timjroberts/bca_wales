...
const inputs = [
  ...
  ...Object.entries(contextUrls).map(([id, url]) => input({
    ...
    media_type: "application/geo+json",
    maximum_bytes: oldInputs.get(id).maximum_bytes,
...
const steps = [
  ...
  ]),
  {
    ...
    argv: ["/repo/tooling/geodata/recipes/build_release_summary_v2.py", "--context", "{artifact:context-summary}", "--terrain", "{artifact:terrain-summary}", "--change", "{artifact:change-report}", "--release-id", "release-blorenge-2026-08-21.1", "--dataset-version", "2026-08-21.1", "--output", "{artifact:release-summary}"],
...
const datasets = [
  {
    dataset_id: "landscape-context", source_dataset_ids: ["bca-area-of-interest", "nrw-sssi", "nrw-national-park", "osm-wales-geofabrik", "nrw-main-rivers", "nrw-phase1-vegetation-voronoi"], evidence_version: "2026-08-21.1",
  ...
  {
    dataset_id: "terrain", source_dataset_ids: ["bca-area-of-interest", "wg-lidar-dtm-2020-2023"], evidence_version: "2026-08-21.1",
  ...
  {
    dataset_id: "observed-change", source_dataset_ids: ["bca-area-of-interest", "copernicus-sentinel-2-l2a", "usgs-landsat-c2-l2-sr"], evidence_version: "2026-08-21.1",
  ...
  {
    dataset_id: "ndvi-change", source_dataset_ids: ["bca-area-of-interest", "copernicus-sentinel-2-l2a"], evidence_version: "2026-08-21.1",
  ...
  {
    dataset_id: "ndmi-change", source_dataset_ids: ["bca-area-of-interest", "copernicus-sentinel-2-l2a"], evidence_version: "2026-08-21.1",
  ...
  {
    dataset_id: "effis-event", source_dataset_ids: ["bca-area-of-interest", "effis-current-burnt-areas"], evidence_version: "2026-08-21.1",
...
const recipe = {
  ...
  release_id: "release-blorenge-2026-08-21.1",
