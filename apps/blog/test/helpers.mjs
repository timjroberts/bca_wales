...
export async function setup(t, worker = false, overrides = {}) {
  ...
  const mf = new Miniflare(convertV4MiniflareOptions({ modules: true, script, bindings: { ORIGIN: 'https://bca.wales', AUTH_ENABLED: 'false', ...overrides }, compatibilityDate: '2026-08-01', d1Databases: ['DB'], r2Buckets: ['CONTENT','RECOVERY'] }));
  t.after(() => mf.dispose());
